...
class WiseAgentRegistry:
    ...
    @classmethod
    def find_file(cls, file_name, config_directory="") -> str:
        """
        ...
        # If the file is not found in any of these locations, return None
    ...
    def get_config(cls) -> dict[str, Any]:
        ...
        try: 
            if cls.config is None or cls.config == {}:
                cls.find_file(file_name="registry_config.yaml", config_directory=".wise-agents")
